...
(pretrained on Moments in Time) R3 features extracted from the Moments in Time dataset.',
             'model_type': 'convlstm',
             'training_data_dir': '../prednet/results/prednet_50v__moments_nano__R3/training',
             'validation_data_dir': '../prednet/results/prednet_50v__moments_nano__R3/validation',
             'test_data_dir': '../prednet/results/prednet_50v__moments_nano__R3/training',
             'classes': ['cooking', 'walking']}, prednet_base_config)
